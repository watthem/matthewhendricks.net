<template lang="html">
  <div class="wonder-wall h-96 m-auto sm:flex-row flex sm:w-full w-2/3  justify-center ">
    <div class="card-link mx-10 bg-gray-100 p-10 m-auto">
      <div class="h-96">
        <h3 class="title text-blue-500">Helpful subjects</h3>
          <ul class="list-disc">
          <li class="py-5">
          <g-link class="underline " to="/blog/">
            Read blog posts
          </g-link>
        </li>
        <li class="py-5">
          <g-link class="underline" to="/archive/">
           View archive
          </g-link>
        </li>
        </ul>
    ...
    <div class="card-link mx-10 bg-gray-100 p-10">
      <div class="wall spacer">
        <div class style>
          <h3 class="title text-blue-500">Work portfolio</h3>

          <ul class="list-disc">
            <li class="py-5"><g-link class="underline" to="/work/">
             See examples
            </g-link></li>
          
          
            <li class="py-5"><g-link class="underline" to="/resume/">
             View resume
            </g-link></li>
          </ul>
