  ...
  <section class="w-2/3 m-auto ">
    ...
    >
      ...
      >
        <div class="lg:w-1/2">
          <div
            class="h-64 bg-contain bg-no-repeat bg-center lg:rounded-lg lg:h-full"
            style="background-image:url('/nt_logo.png')"
          ></div>
        </div>
      ...
      >
        <div class="lg:w-1/2">
          <div
            ...
            style="background-image:url('/ookla_logo.png')"
          ></div>
        </div>
