...
By now you have probably read plenty of headlines and pundit takes: You look past the cartoon memes and volatility of cryptocurrencies, you’ll see there are practical applications for these nifty little contraptions. And soon, many believe these standards will define more than AI arranged pixels.
...
Before ERC-721, mutability limited the economy to the exchange of value-based agreements to correlative measures of assets like precious metals, foreign currencies, or the price of food. Now, thanks to these simultaneous digital revolutions, frankly, immutability on the blockchain opens a world where we could make a global digital description of almost anything!

The history of Web 2.0 is precisely what makes Web 3.0 on beyond so incredible to be witnessing.
...
If we can extrapolate data that describes a specific piece of property, content property or a piece of data, we can then describe ownership and keep a ledger of who keeps this information — in a way that is nearly impossible to dispute.

Since it’s all the meta information that describes the contents and an unbiased observation of the transaction, validated, and documented by a 3rd party. Automatically.
...
It would not be too far-fetched from today’s models to implement fair and transparent AI inspired techniques like a universal query engine that can factor in industry agreement upon milestone measurements. Or process discovery through a Case-Based Reasoning (CBR) process models to help plan and rationalize both organizational and individual worker goals.
...
They could also use NFTs by consumers exchanged as stake as needed for various regulatory requirements, traded for other currencies through automated market makers, or stored in value that may also be rebase and compound by the policy to earn additional APY for simply holding the stake in the protocol.
